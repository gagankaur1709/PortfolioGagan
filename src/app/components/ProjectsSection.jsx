...
const projects = [
  {
    ...
    description: "The primary goal is to systematically evaluate and compare the effectiveness, cost, and maintainability of tests generated by Large Language Models (LLMs) versus traditional automated test generation tools across benchmarks of varying complexity.",
    image: "/LLM.jpg",
  ...
  {
    title: "StudySync",
    description: "StudySync is a web application designed to help students find study partners and groups based on their preferences and availability. The application includes features such as user authentication, profile management, matching algorithm, and chat functionality.",
    image: "/study.jpg",
    tags: ["Python", "JavaScript", "CSS", "HTML"],
    repoUrl: "https://github.com/BugBusters101/StudySync",
  },
  {
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                <h3 className="text-4xl font-bold mb-2 text-center text-gray-100">{project.title}</h3>
                                <p className="text-gray-400 mb-4 text-center flex-grow">{project.description}</p>
